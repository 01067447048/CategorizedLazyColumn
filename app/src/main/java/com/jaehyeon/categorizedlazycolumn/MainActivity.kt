package com.jaehyeon.categorizedlazycolumn
...
import com.jaehyeon.categorizedlazycolumn.ui.theme.CategorizedLazyColumnTheme
...
@Preview
@Composable
private fun CategorizedLazyColumnPreView() {
    val namesList = names.map {
        Category(
            name = it.key.toString(),
            items = it.value
